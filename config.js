module.exports = {
  ...
  // i.e: "-keystonebot foo" will trigger the command "foo",
  //      whereas "Keystonebot foo" will do nothing at all.
  prefix:  "-keystonebot",

  // Your bot's user token. If you don't know what that is, go here:
  // https://discordapp.com/developers/applications/me
  // Then create a new application and grab your token.
  token: "Mjk4OTg0NzEyMzU2MTAyMTQ1.C8XSvg.EGLIY4HnOQhuu7y1oDUMJFcB-tI",
